...
E <-  as.numeric(Shift_E)         # Shift_E =  435000 
N <- as.numeric(Shift_N)         # Shift_N =   5451000  
...
site_3d_local <- vcgImport(site_3d_gps_pth)
...
sampled_data <- vertices_crs %>% 
  sample_frac(0.001)

st_write(sampled_data,"sampled_data.kml",delete_dsn = T)
