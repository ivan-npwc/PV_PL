...
#pth = file.path("C:\\Users\\usato\\SSL_DB\\TRAIN\\TRAIN_pv\\No zero\\checkpoints_deeplabv3\\finetuned_deeplabv3_cell_segmentation.h5")

#model_DeepLabV3 <- load_model_hdf5(
#  pth,
#  custom_objects = list(
#    'dice_coef' = dice_coef,
#   # 'iou' = iou_metric,
