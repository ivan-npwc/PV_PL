...
# labelInput  = "D:\\PV_DB/2023_H0054_OPP/20230503_082013/20230503_082013_MINI3PRO_20m_DUMMY/"     
 ...
 ImageMaskConcetence = T	
  ...
  PTHweight = "C:\\Users\\usato\\Documents\\YandexDisk\\System_data_LRG\\weights\\simple_deeplabv3"
  if (file.exists(PTHweight)==F){stop("Weight path is invalid")}
 # if(exists("unet1")==F)   {source("Modules/UNET/UnetVGGCreate_Alin.r")}
   if(exists("model")==F)   {source(file.path("C:\\Users\\usato\\SSL_DB\\PV_PL\\Modules\\UNET\\TRAIN TF2\\create_simple_deeplabv3.r"))}
